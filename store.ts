...
/** A single social media platform configuration entry. */
export interface SocialMediaEntry {
  /** Unique platform key (e.g. "facebook"). */
  platform: "facebook" | "instagram" | "twitter" | "telegram" | "whatsapp";
  /** Display name shown in the admin UI. */
  label: string;
  /** The handle or username for this platform (e.g. "@XpressProfx"). */
  username: string;
  /** Full public URL to the profile or channel. */
  url: string;
  /** When false the link is hidden from the public-facing site. */
  active: boolean;
}

/** Platform-wide social media link configuration (admin controlled). */
export const socialMediaSettings: SocialMediaEntry[] = [
  { platform: "facebook",  label: "Facebook",  username: "", url: "", active: false },
  { platform: "instagram", label: "Instagram", username: "", url: "", active: false },
  { platform: "twitter",   label: "Twitter",   username: "", url: "", active: false },
  { platform: "telegram",  label: "Telegram",  username: "", url: "", active: false },
  { platform: "whatsapp",  label: "WhatsApp",  username: "", url: "", active: false },
];
